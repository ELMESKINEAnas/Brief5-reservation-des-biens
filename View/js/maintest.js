...
document.addEventListener("input", function(e){
    ...
    for(let i = 1  ; i<= nbchild.value ; i++){
        ...
        if(e.target.id == `id-age${i}` && (e.target.value <= 2 &&  e.target.value >= 0)){
            ...
            document.querySelector(`#offre-enf${i}`).innerHTML = 
            `
...
for(let i = 0  ; i< nbchild.value ; i++){
    switch (enf_data[i]){
        case 'option1':
            ...
            totale += 300*enfant_option.option1
            break;

        case 'option2':
            console.log(300*enfant_option.option2)
            totale += 300*enfant_option.option2
            break;

        case 'option3':
            console.log(300*enfant_option.option3)
            totale += 300*enfant_option.option3
            break;

        case 'option4':
            console.log(300*enfant_option.option4)
            totale += 300*enfant_option.option4
            break;

        case 'option5':
            console.log(300*enfant_option.option5)
            totale += 300*enfant_option.option5
            break;
...
console.log("prix totale = "+totale)
}
)